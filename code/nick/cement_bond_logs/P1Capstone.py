...
class Reader_cbl:
    ...
    #type_reading is the third method that is not doing the same thing upon initialization
    ...
    def save_plot_a_log(self, for_that_well, dpi_user = 300):
        ...
        plt.tight_layout(pad=2.0) # set distance between two plots
        plt.savefig('well_report_plot.png', dpi = dpi_user)
        plt.show()
        print('Your visualization of the well logs have been saved as well_report_plot.png')
    ...
    def save_plot_a_log_with_hlines(self, for_that_well, top_line, bottom_line, x_min_vdl, x_max_vdl, x_min_amp, x_max_amp, dpi_user = 300):
        ...
        plt.savefig('well_report_plot.png', dpi = dpi_user)
        plt.show()
        print('Your annotation of the well logs have been saved as well_report_plot.png')
