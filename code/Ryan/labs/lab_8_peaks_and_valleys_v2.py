...
for each_number in range(len(data)-1):
    change = data[each_number+1] - data[each_number]
...
def peaks(data):
    if type(data) != "integer":
        ...
        if result_list[data] == -1:
            ...
            output = ""
        return #print(peaks_list[0], peaks_list[-1]) #print(peaks_list)    
    else:
...
def valleys(data):
    ...
    #print(valleys_list)
        if result_list[data] == 1:
            ...
            output = ""
        return #print(valleys_list)#print(valleys_list[0], valleys_list[-1]) 
    else:
        return "Wrong datatype"
...
#print(peaks_list)
#print(valleys_list)
#print(f"Peaks at: {peaks(data)}")
#print(f"Valleys at: {valleys(data)}")
print(f"Peaks and Valleys list\n{peaks_and_valleys(peaks_list, valleys_list)}")
