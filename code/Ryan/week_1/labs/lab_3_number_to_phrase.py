...
for w in word_number_dict:
    if number_input == w:
        print(word_number_dict[w])
        exit()
...
def number_to_word(number):
    ...
    if len(number_input) == 3:
        ...
        if word_number[number_input[1]] == "Zero":
            digit_2 = ""
        elif word_number[number_input[1]] == "10":
            digit_2 = "Ten"
        elif word_number[number_input[1]] == "11":
            digit_2 = "Eleven"
        elif word_number[number_input[1]] == "12":
            digit_2 = "Twelve"
        elif word_number[number_input[1]] == "13":
            digit_2 = "Thirteen"
        elif word_number[number_input[1]] == "15":
            digit_2 = "Fifteen" 
        elif word_number[number_input[1]] == "20":
            digit_2 = "Twenty"
        elif word_number[number_input[1]] == "30":
            digit_2 = "Thirty"
        elif word_number[number_input[1]] == "50":
            digit_2 = "Fifty" 
        else:
