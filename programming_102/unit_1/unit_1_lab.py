...
while True:
    ...
    if user == computer: # <<< Error 2: "users" variable does not exist
        print("Looks like a tie") # <<< Error 1: Missing paren
    ...
    # check all cases if user is rock
        ...
        # check losing case
        elif computer == "paper": # <<< Error 3: Incorrect loss condition. Changed rock to paper
    ...
    # check all cases if user is paper
        ...
        # check winning case
        if computer == "rock": # <<< Error 4: Missing ":"
            print("You win!")
    ...
    # check all cases if user is scissors
        ...
        # check losing case
            ...
            print("Sorry, You lose.") # <<< Error 5: Syntax error with print function. Changed "P" to "p"